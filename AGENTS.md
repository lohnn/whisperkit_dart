...
*   **`macos/`**: Swift library source code.
...
If you modify files in `macos/`, you **MUST** rebuild the Swift library:
...
If you modify `macos/Sources/WhisperWrapper/include/WhisperWrapper.h`, you **MUST** regenerate the Dart bindings:
